...
test("getMyAgents", async () => {
	let getMyAgents = await wakaClient.getMyAgents().catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getMyOrgDashboardMembers", async () => {
	...
	console.log(getMyOrgDashboardMembers);
});

test("orgDashboardMemberSummaries", async () => {
	let orgDashboardMemberSummaries = await wakaClient
		.orgDashboardMemberSummaries(myWakaId, process.env.ORG, process.env.DASHBOARD, myWakaId, "Dec 20 2021", "Dec 29 2021")
		.catch((err) => {
			console.log(err);
			throw err;
		});
...
test("orgDashboardMemberDurations", async () => {
	let orgDashboardMemberDurations = await wakaClient
		.orgDashboardMemberDurations(myWakaId, process.env.ORG, process.env.DASHBOARD, myWakaId, "Dec 29 2021")
		.catch((err) => {
			console.log(err);
			throw err;
		});
...
test("getMyOrgDashboardMemberDurations", async () => {
	let getMyOrgDashboardMemberDurations = await wakaClient
		.getMyOrgDashboardMemberDurations(process.env.ORG, process.env.DASHBOARD, myWakaId, "Dec 29 2021")
		.catch((err) => {
			console.log(err);
			throw err;
		});
...
test("getUserHeartbeats", async () => {
	let getUserHeartbeats = await wakaClient.getUserHeartbeats(myWakaId, "Dec 29 2021").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getMyHeartbeats", async () => {
	let getMyHeartbeats = await wakaClient.getMyHeartbeats("Dec 29 2021").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getUserExternalDurations", async () => {
	let getUserExternalDurations = await wakaClient.getUserExternalDurations(myWakaId, "Dec 29 2021").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getMyExternalDurations", async () => {
	let getMyExternalDurations = await wakaClient.getMyExternalDurations("Dec 29 2021").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getUserDurations", async () => {
	let getUserDurations = await wakaClient.getUserDurations(myWakaId, "Dec 29 2021").catch((err) => {
		console.log(err);
		throw err;
	});
});

test("getMyDurations", async () => {
...
test("getUserCommits", async () => {
	let getUserCommits = await wakaClient.getUserCommits(myWakaId, "wakatime-api").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getMyCommits", async () => {
	let getMyCommits = await wakaClient.getMyCommits("wakatime-api").catch((err) => {
		console.log(err);
		throw err;
	});
});
...
test("getUserAllTimeSinceToday", async () => {
	let getUserAllTimeSinceToday = await wakaClient.getUserAllTimeSinceToday(myWakaId).catch((err) => {
		console.log(err);
		throw err;
	});
});

test("getMyAllTimeSinceToday", async () => {
	let getMyAllTimeSinceToday = await wakaClient.getMyAllTimeSinceToday(myWakaId).catch((err) => {
		console.log(err);
		throw err;
	});
});
